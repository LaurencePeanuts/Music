...
beatbox.You.solve_for_3D_potential(beatbox.You.all_simulated_universes[-1].ay2ayreal_for_inference(beatbox.You.all_simulated_universes[-1].ay), print_alpha = 0)
...
realbias = (beatbox.You.all_reconstructed_universes[-1].fn - beatbox.You.all_simulated_universes[-1].fn)[:(len(beatbox.You.all_reconstructed_universes[-1].fn)/2)]
imagbias = (beatbox.You.all_reconstructed_universes[-1].fn  -beatbox.You.all_simulated_universes[-1].fn)[(len(beatbox.You.all_reconstructed_universes[-1].fn)/2):]
...
n2, bins2, patches2 = plt.hist(imagbias, 80, normed=0, facecolor='yellow', alpha=0.75)
