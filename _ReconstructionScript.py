...
if not os.path.isfile('data/covCyy_lmax10.txt'):
    beatbox.You.read_Planck_samples()
    beatbox.You.calculate_covariance_matrix(filename='lmax10')
else:
    beatbox.You.load_covariance_matrix(filename='covCyy_lmax10.txt')
