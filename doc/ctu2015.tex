...
\be
{\bf \tilde{d}} = {\bf R} \, {\bf \tilde{s}} + {\boldsymbol{\epsilon}}.
\ee
...
\be
\tilde{\Pot}^{\rm MV}({\bf x}_i) \equiv \left({\bf F} \, {\bf \tilde{d}}\right)_i = \sum_{kl}  \xi_\Pot(|{\bf x}_{i} - {\bf x}_{i_k}|) \, \left(\boldsymbol{\xi}_\Pot + \sigma^2_\epsilon \, {\bf I}\right)^{-1}_{kl} \, \tilde{\hat{\Pot}}({\bf x}_l)
\ee
