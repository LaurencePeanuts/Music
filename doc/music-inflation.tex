...
\bea
	&\mathcal{P}&(f_n | a_{lm}, \vec{\eta}, C_f^{-1})\propto \nonumber\\
	&&\exp\left[-\frac{1}{2} \left( f_n^T-a^T_{lm}C_a^{-1}\mathbf{R}\mathbf{A}^{-1} \right) \mathbf{A}\left(f_n-\mathbf{A}^{-1}\mathbf{R}^TC_a^{-1} a_{lm} \right) \right]\exp\left[\frac{1}{2} a_{lm}^T\left(C_a^{-1}\mathrm{R} \mathbf{A}^{-1} \mathrm{R}^TC_a^{-1} -C_a^{-1} \right) a_{lm} \right]\, .
...
\bea
	-C^{-1}_p=Z\left. \frac{\partial^2 \mathcal{P}(f_n | a_{lm}, \vec{\eta}, C_f^{-1})}{\partial f_n^2} \right|_{f_n=\langle f_n\rangle}&=& \left. \left(-\mathbf{A} + (-f_n^T\mathbf{A}+a^T_{lm}C_a^{-1}\mathbf{R}\mathbf{A}^{-1}\mathbf{A})^2 \right)\mathcal{P}(f_n | a_{lm}, \vec{\eta}, C_f^{-1})\right|_{f_n=\langle f_n\rangle}\nonumber\\
	&=& -\mathbf{A}
\eea
