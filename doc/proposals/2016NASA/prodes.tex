...
%a) 3D gravitational potential at the time
...
LPL: check this - needs rewording.
...
\caption{{\small LPL: This is the reconstruction fromPlanck data. I will write a caption soon!}}
\label{Fig:PlanckRec}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
